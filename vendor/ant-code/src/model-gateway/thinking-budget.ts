 ...
 */
export function limitThinkingPreview(value: string, maxBytes: number = DEFAULT_THINKING_PREVIEW_BYTES) {
 ...
 * @param {number} maxBytes
 */
export function appendThinkingPreview(current: string, addition: string, maxBytes: number = DEFAULT_THINKING_PREVIEW_BYTES) {
