...
class TifWorkbenchViewBuilder:
    ...
    def create_widgets(self):
        ...
        self._slice_drag_render_timer = QTimer(self)
        self._slice_drag_render_timer.setSingleShot(True)
        self._slice_drag_render_timer.timeout.connect(self._render_debounced_drag_slice)
        self.slice_slider.sliderPressed.connect(self.on_slice_slider_pressed)
        self.slice_slider.sliderReleased.connect(self.on_slice_slider_released)
        ...
        self.btn_import_tif = QPushButton("Import TIF volume")
        self.btn_import_tif.setObjectName("tifImportStackButton")
        self.btn_import_tif.clicked.connect(self.import_tif_stack_dialog)
        self.btn_import_tif_slices = QPushButton("Combine TIF slices")
        self.btn_import_tif_slices.setObjectName("tifImportSliceSeriesButton")
        self.btn_import_tif_slices.clicked.connect(self.import_tif_slice_series_dialog)
    ...
    def build_layout(self):
        ...
        import_button_grid = QGridLayout()
        import_button_grid.setContentsMargins(0, 0, 0, 0)
