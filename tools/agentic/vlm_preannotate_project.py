...
def main() -> int:
    ...
    parser.add_argument("--dry-run", action="store_true", help="Create grid overlays and reports without calling the model.")
    parser.add_argument("--prediction-json", default="", help="Offline fixture containing raw VLM responses or detections.")
    parser.add_argument("--artifacts-dir", default="", help="Directory for grid overlays and VLM reports.")
