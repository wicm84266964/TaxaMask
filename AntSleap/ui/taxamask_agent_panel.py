...
""".replace("__TAXAMASK_EMBED_STYLE__", json.dumps(self._web_embed_style_source())).replace("__TAXAMASK_THEME__", json.dumps(self._embed_theme_name()))
    ...
    def _context_prompt(self, context):
        ...
        zh_mapping = [
            ...
            ("project_type", "项目类型"),
            ("project_path", "项目路径"),
            ("storage_inventory_report", "存储占用报告"),
            ("storage_cleanup_report", "清理计划报告"),
            ("storage_report_directory", "报告目录"),
            ("storage_logical_bytes", "逻辑占用"),
            ("storage_unique_bytes", "唯一占用"),
            ("storage_candidate_count", "可清理候选数"),
            ("storage_blocked_count", "受阻候选数"),
            ("storage_unknown_protected_count", "未知且受保护项目数"),
            ("storage_expected_release_bytes", "预计可释放空间"),
            ("storage_plan_state", "清理计划状态"),
            ("storage_agent_request", "交给智能体的任务"),
            ("active_specimen_id", "当前 specimen"),
            ("active_volume_scope", "当前体数据范围"),
            ("active_part_id", "当前 part"),
            ("active_reslice_id", "当前重切片"),
            ("active_part_parent_bbox_zyx", "当前 part 来源 bbox"),
            ("active_part_group_tags", "当前 part 分组标签"),
            ...
            ("predict_group_filter", "预测分组筛选"),
            ("predict_group_filter_label", "预测分组筛选名称"),
            ("predict_target_summary", "预测目标摘要"),
            ("predict_selected_target_count", "已选预测目标数"),
            ("predict_selected_targets", "已选预测目标"),
            ("tif_task_summary", "TIF 任务状态摘要"),
            ("tif_state_summary", "TIF 工作台状态摘要"),
            ("preview_resource_summary", "TIF 预览资源摘要"),
            ("local_axis_state_summary", "Local Axis 状态摘要"),
            ("volume_lifecycle_summary", "体数据加载与预览生命周期"),
            ...
            ("volume_surface_refine", "体预览表面细化"),
            ("volume_clip_plane", "观察侧剖切面"),
            ("volume_clip_plane_depth", "观察侧剖切面深度"),
            ("volume_roi_high_detail", "ROI 高细节预览"),
            ("volume_roi_inspect", "ROI 真实裁剪检查"),
            ("volume_roi_scale", "ROI 高细节倍率"),
            ("volume_roi_budget", "ROI 纹理预算"),
            ...
            ("volume_uploaded_gb", "体预览上传体积"),
            ("volume_upload_ms", "体预览上传耗时"),
            ("volume_draw_ms", "体预览绘制耗时"),
        ...
        en_mapping = [
            ...
            ("storage_inventory_report", "Storage inventory report"),
            ("storage_cleanup_report", "Cleanup plan report"),
            ("storage_report_directory", "Report directory"),
            ("storage_logical_bytes", "Logical occupancy"),
            ("storage_unique_bytes", "Unique occupancy"),
            ("storage_candidate_count", "Cleanup candidates"),
            ("storage_blocked_count", "Blocked candidates"),
            ("storage_unknown_protected_count", "Unknown protected items"),
            ("storage_expected_release_bytes", "Expected release"),
            ("storage_plan_state", "Cleanup plan state"),
            ("storage_agent_request", "Agent task"),
            ("active_specimen_id", "Active specimen"),
            ("active_volume_scope", "Active volume scope"),
            ("active_part_id", "Active part"),
            ("active_reslice_id", "Active reslice"),
            ("active_part_parent_bbox_zyx", "Active part source bbox"),
            ("active_part_group_tags", "Active part group tags"),
            ...
            ("predict_group_filter", "Prediction group filter"),
            ("predict_group_filter_label", "Prediction group filter label"),
            ("predict_target_summary", "Prediction target summary"),
            ("predict_selected_target_count", "Selected prediction target count"),
            ("predict_selected_targets", "Selected prediction targets"),
            ("tif_task_summary", "TIF task summary"),
            ("tif_state_summary", "TIF workbench state summary"),
            ("preview_resource_summary", "TIF preview resource summary"),
            ("local_axis_state_summary", "Local Axis state summary"),
            ("volume_lifecycle_summary", "Volume loading and preview lifecycle"),
            ...
            ("volume_surface_refine", "Volume surface refine"),
            ("volume_clip_plane", "Observation-side clip plane"),
            ("volume_clip_plane_depth", "Observation-side clip depth"),
            ("volume_roi_high_detail", "ROI high-detail preview"),
            ("volume_roi_inspect", "ROI true-crop inspection"),
            ("volume_roi_scale", "ROI high-detail scale"),
            ("volume_roi_budget", "ROI texture budget"),
            ...
            ("volume_uploaded_gb", "Volume uploaded size"),
            ("volume_upload_ms", "Volume upload ms"),
            ("volume_draw_ms", "Volume draw ms"),
