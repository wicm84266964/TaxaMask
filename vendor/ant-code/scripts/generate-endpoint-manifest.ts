...
import { AUDIT_DIR, collectFiles, ensureAuditDir, rel, stableJson } from "./audit-common.ts";
...
const IGNORE_FILES = new Set(["scripts/generate-endpoint-manifest.ts", "scripts/generate-endpoint-manifest.js"]);
 ...
 * @param {number} line
 */
function classifyUrl(rawUrl: string, file: string, line: number) {
...
function compareUrlEntry(a: UrlEntry, b: UrlEntry) {
