...
> 适用版本：2026-05-29 Agent Center / Ask Agent 路由 / TIF-STL 分流 / 主工作台 Blink 合并 / VLM 第一公里预标注 / TIF GPU 体预览 / PDF 蚂蚁分类学图版宽松复核默认版
>
...
右侧父子精修区只显示当前 route、父级上下文、父级框和专家状态，并提供自动标注、自动收缩和训练按钮。
