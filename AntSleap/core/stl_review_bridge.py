...
STL_REVIEW_PROVENANCE_SCHEMA_VERSION = "taxamask_stl_review_provenance_v1"
...
def _register_rendered_view_records_for_2d_review(records, project_manager):
    ...
    for record in existing_records:
        provenance = {
            ...
            "workflow_note": "Surface morphology review uses rendered 2D views in the Labeling Workbench and Blink; TaxaMask does not write labels back to the source STL model.",
        }
