import { getAgentProfile } from "./profiles.ts";
 ...
 */
export function createInternalAgentRequest(options: { profileName: string; config?: Record<string, unknown>; cwd?: string; task: string; input: string; rules?: string[] }) {
 ...
 */
export function truncateInternalInput(value: unknown, max: number | null = null) {
