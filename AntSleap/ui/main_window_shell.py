...
class MainWindowShellMixin:
    ...
    def _build_main_window_views(self):
        ...
        self.workbench_overflow_menu = QMenu(self)
        self.btn_more_actions = QToolButton()
        self.btn_more_actions.setObjectName("workbenchMoreActionsButton")
        self.btn_more_actions.setPopupMode(QToolButton.InstantPopup)
        self.btn_more_actions.setMenu(self.workbench_overflow_menu)
        ...
        apply_semantic_button_style(self.btn_more_actions, BUTTON_ROLE_NEUTRAL, "padding: 5px 10px;")
        self.workbench_overflow_menu.aboutToShow.connect(self._sync_workbench_overflow_menu)
        ...
        self.btn_batch_split_panels.setVisible(False)
        ...
        self.btn_vlm_preannotate_batch.setVisible(False)
        toolbar_flow_layout.addWidget(self.btn_agent_from_workbench)
        toolbar_flow_layout.addWidget(self.btn_more_actions)
        ...
        self.workbench_inspector_tabs = QTabWidget()
        self.workbench_inspector_tabs.setObjectName("workbenchInspectorTabs")
        self.workbench_inspector_tabs.setDocumentMode(True)
        self.workbench_inspector_current_image_page, self.workbench_inspector_current_image_layout = self._make_workbench_inspector_page("workbenchInspectorCurrentImagePage")
        self.workbench_inspector_auto_page, self.workbench_inspector_auto_layout = self._make_workbench_inspector_page("workbenchInspectorAutoPage")
        self.workbench_inspector_run_page, self.workbench_inspector_run_layout = self._make_workbench_inspector_page("workbenchInspectorRunPage")
        self.workbench_inspector_tabs.addTab(self.workbench_inspector_current_image_page, tr("Current Image", self.current_lang))
        self.workbench_inspector_tabs.addTab(self.workbench_inspector_auto_page, tr("Auto Annotation", self.current_lang))
        self.workbench_inspector_tabs.addTab(self.workbench_inspector_run_page, tr("Run & Logs", self.current_lang))
        right_panel = QWidget()
        ...
        right_layout.addWidget(self.workbench_inspector_tabs)
        ...
        self.part_list.setMinimumHeight(140)
        self.part_list.setMaximumHeight(300)
        self.part_list.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        metadata_layout.addWidget(self.part_list, 1)
        ...
        self.workbench_inspector_current_image_layout.addWidget(self.metadata_panel)
        self.workbench_inspector_current_image_layout.addStretch(1)
        ...
        self.workbench_inspector_auto_layout.addWidget(self.ai_panel)
        self.workbench_inspector_auto_layout.addStretch(1)
        ...
        self.workbench_inspector_run_layout.addWidget(self.training_progress_panel)
        self.workbench_inspector_run_layout.addWidget(self.logs_panel, 1)
        self.workbench_splitter.addWidget(right_panel)
    ...
    def _make_workbench_inspector_page(self, object_name):
        scroll = QScrollArea()
    ...
    def _sync_workbench_overflow_menu(self):
        menu = getattr(self, "workbench_overflow_menu", None)
        if menu is None:
            return
        menu.clear()
        for attr in ("btn_crop", "btn_batch_split_panels", "btn_vlm_preannotate_batch"):
            button = getattr(self, attr, None)
            if button is None:
                continue
            action = QAction(button.text(), menu)
            action.setEnabled(button.isEnabled())
            action.setToolTip(button.toolTip())
            action.triggered.connect(lambda checked=False, b=button: b.click())
