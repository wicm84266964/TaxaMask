...
class GuiSmokeTests(unittest.TestCase):
    ...
    def test_agent_panel_embed_style_switches_to_light_theme(self):
        ...
        try:
            ...
            self.assertIn("#B9CADB", css)
            self.assertIn(".taxamask-embed .background-subagent-chip", css)
            self.assertIn(".taxamask-embed .live-subagent-row", css)
            self.assertIn(".taxamask-embed .question-choice", css)
