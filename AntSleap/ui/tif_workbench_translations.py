...
TIF_TRANSLATIONS = {
    "zh": {
        ...
        "Loading selected TIF slice...": "正在后台读取所选 TIF 切片...",
        "TIF slice loading failed: {0}": "TIF 切片读取失败：{0}",
        "TIF slice review": "TIF 切片复核",
        "The current slice is still loading. Wait a moment, then close the project again.": "当前切片仍在读取。请稍等片刻后再次关闭项目。",
        ...
        "Train/export": "训练/导出",
        "Review": "复核预览",
        "Import & Preview": "导入与预览",
        "Part Extraction": "部位切分",
        "Annotation / training": "标注与训练",
        "Label review": "标注核验",
        "Train / predict": "训练与预测",
        "Result comparison": "结果对比",
        "Label {0} cannot be stored in the current label layer ({1}). Create or migrate the layer with a wider label dtype before painting.": "当前标签层（{1}）存不下标签 {0}。请先用更大的整数类型创建或迁移该层，再继续绘制。",
        "leave empty for backend-required format only": "留空则只生成当前后端真正需要的格式",
        "Storage": "存储管理",
        "Storage management": "存储管理",
        "Analyze occupancy": "分析占用",
        "Generate cleanup plan": "生成清理计划",
        "Ask embedded Agent": "交给内嵌智能体",
        "Open latest report": "打开最新报告",
        "No storage scan yet.": "尚未分析占用。",
        "Scanning storage occupancy...": "正在分析存储占用...",
        "Scanning project storage...": "正在扫描项目存储...",
        "Building dry-run cleanup plan...": "正在生成 dry-run 清理计划...",
        "Storage scan finished": "存储扫描完成",
        "Storage scan cancelled.": "存储扫描已取消。",
        "A storage operation is already running.": "已有存储操作正在运行。",
        "Open a SQLite TIF project before using storage management.": "请先打开 SQLite TIF 项目，再使用存储管理。",
        "No report has been generated yet.": "还没有生成报告。",
        "Generate a cleanup plan before asking the embedded Agent.": "请先生成清理计划，再交给内嵌智能体。",
        "Opened report: {0}": "已打开报告：{0}",
        "Read the latest occupancy inventory and cleanup plan, explain what can be safely reclaimed and what remains protected, and give a clear recommendation for the current large TIF dataset. Do not move or delete any file without the researcher's explicit authorization.": "请读取最新占用盘点和清理计划，说明哪些内容可以安全释放、哪些仍受保护，并对当前大体积 TIF 数据给出明确建议。未经研究者明确授权，不得移动或删除任何文件。",
        "Layer": "层级",
        "Status": "状态",
        "Reason": "原因",
        "Occupancy {0}. Unique allocated {1}. Unknown protected items {2}.": "逻辑占用 {0}；去除 hardlink 重复后的唯一占用 {1}；未知且已保护 {2} 项。",
        "Dry-run candidates {0}, blocked {1}, estimated release {2}. Nothing was deleted.": "dry-run 候选 {0} 项，阻止 {1} 项，预计可释放 {2}；没有删除任何文件。",
        "Occupancy analysis is read-only. Cleanup plans automatically rescan and only include registered, verified caches; historical unregistered files remain protected.": "占用分析只读；生成清理计划时会自动重新扫描，并且只纳入已登记、已验证的缓存。历史未登记文件保持受保护。",
        "The cleanup plan was generated successfully, but this project has no registered reproducible caches. Historical unregistered files remain protected.": "清理计划已成功生成，但当前项目没有已登记的可再生成缓存；历史未登记文件仍受保护。",
        "The storage operation is still stopping. Wait a moment, then close the project again.": "存储操作仍在停止。请稍等片刻后再次关闭项目。",
        ...
        "Use the bound region label schema above as the brush label selector. Select a colored row there, then paint or fill on the slice.": "上方已绑定的结构区域标签表就是画笔标签选择器。选中一行彩色标签后，再用画笔或填充工具标注切片。",
        "Bind a region label schema above before painting this part/reslice. The brush uses the bound schema once it is set.": "请先在上方绑定结构区域标签表，再标注当前部位或重切片。绑定后画笔会直接使用这张标签表。",
        ...
        "Drafted label schema {0}. Edit labels, then save or bind it to the current part.": "已草拟标签表 {0}。请编辑标签后保存，或绑定到当前部位。",
        ...
        "Drafted group tag {0}. Save it, then check Assigned and apply it to the current part.": "已草拟分组标签 {0}。请先保存它，再勾选“已分配”并应用到当前部位。",
        ...
        "Export reviewed label STL": "导出审核标签 STL",
        "Create Blender-ready STL only from the current reviewed manual truth.": "仅从当前已人工审核的训练真值生成可供 Blender 使用的 STL。",
        "Mesh export": "网格导出",
        "Select a TIF volume before exporting reviewed label meshes.": "请先选择一个 TIF 体数据，再导出审核标签网格。",
        "The current object has no reviewed training truth. Use Accept as training truth after review, then export STL.": "当前对象还没有已审核的训练真值。请先复核标注并使用“接受为训练真值”，再导出 STL。",
        "Mesh export could not be opened: {0}": "无法打开网格导出：{0}",
        ...
        "3D volume": "三维体预览",
        "Volume render": "体渲染",
        "The 3D preview is still stopping. Wait a moment, then close the project again.": "三维体预览仍在停止。请稍等片刻后再次关闭项目。",
        "The 3D preview is still stopping. Wait a moment, then delete the part again.": "三维体预览仍在停止。请稍等片刻后再次删除部位。",
        "The part mask preview is still stopping. Wait a moment, then close the project again.": "部位掩膜预览仍在停止。请稍等片刻后再次关闭项目。",
        "Previous volume data is still being released. Wait a moment, then close the project again.": "先前的体数据仍在释放。请稍等片刻后再次关闭项目。",
        "Render mode": "渲染模式",
        "Composite": "透明累积",
        "MIP": "最大强度",
        "MinIP": "最小强度",
        ...
        "Loading selected TIF volume and labels...": "正在加载选中的 TIF 体数据与标签……",
        "Loading selected part volume and labels...": "正在加载选中的部位体数据与标签……",
        "Loading selected reslice and labels...": "正在加载选中的重切片与标签……",
        "Loaded selected TIF volume and labels.": "已加载选中的 TIF 体数据与标签。",
        "Loaded selected part volume and labels.": "已加载选中的部位体数据与标签。",
        "Loaded selected reslice and labels.": "已加载选中的重切片与标签。",
        ...
        "Delete imported volume": "删除导入体数据",
        "Delete imported volume?": "删除导入体数据？",
        "Delete imported volume {0}? This removes the project copy, labels, and cropped parts. The original source TIF on disk is kept.": "确认删除导入体数据 {0} 吗？这会删除项目内的副本、标注和已裁部位，不会删除磁盘上的原始源 TIF。",
        "Deleted imported volume {0}.": "已删除导入体数据 {0}。",
        "Select an imported volume before deleting it.": "请先在左侧栏选择要删除的导入体数据。",
        "The 3D preview is still stopping. Wait a moment, then delete the volume again.": "三维预览仍在停止。请稍等片刻后再删除该体数据。",
        ...
        "Export confirmed Local Axis training manifest": "导出已确认局部轴训练清单",
        "Reslice ID": "重切片编号",
        "Template": "模板",
        ...
        "Exported confirmed Local Axis training manifest: {0} samples\n{1}": "已导出已确认局部轴训练清单：{0} 条样本\n{1}",
        ...
        "Editable AI result is available. Full label-ID validation will run when you accept it as training truth.": "待核验 AI 结果已就绪。完整标签编号校验将在核验为训练真值时执行。",
        "Schema {0}; label scan deferred until acceptance.": "标签表 {0}；全卷标签扫描已延后到核验操作。",
        "This result has not been marked opened for review yet.": "这个结果尚未记录为已打开复核。",
        ...
        "No selected AI results were accepted. Failed: {0}. Cause: {1}": "所选 AI 结果均未通过。失败项：{0}。原因：{1}",
        ...
        "Custom": "自定义",
        "Import TIF volume": "导入完整 TIF 体数据",
        "Each selected TIF file is imported as a separate specimen. Use this when one file already contains the complete volume.": "每个选中的完整 TIF 文件会分别导入为一个样本；适用于单个文件已包含全部切片的体数据。",
        "Combine TIF slices": "合并多个 TIF 切片",
        "Selected single-plane grayscale TIF files are sorted and combined into one specimen. You can select only the slices you need. Size, data type, and photometric meaning must match; physical Z spacing is not inferred.": "将选中的单层灰度 TIF 文件排序后合并为一个样本；可以只选择需要导入的切片。所有切片的尺寸、位深和明暗定义必须一致；程序不会自动推断 Z 向物理间距。",
        ...
        "Import Complete TIF Volume": "导入完整 TIF 体数据",
        "Combine Multiple TIF Slices": "合并多个 TIF 切片",
        "Import AMIRA Directory": "导入 AMIRA 目录",
        "Specimen ID:": "Specimen 编号：",
        "Imported complete TIF volume for specimen {0}. Report: {1}": "已为 specimen {0} 导入完整 TIF 体数据。报告：{1}",
        "Imported {0} selected TIF slice(s) as specimen {1}. Report: {2}": "已将选中的 {0} 张 TIF 切片导入为 specimen {1}。报告：{2}",
        "Importing complete TIF volume...": "正在导入完整 TIF 体数据...",
        "Importing selected TIF slices...": "正在导入选中的 TIF 切片...",
        "Inspecting selected TIF slices": "正在检查选中的 TIF 切片",
        "Preparing selected TIF slice series": "正在准备 TIF 切片序列",
        "Reading selected TIF slices": "正在逐张读取选中的 TIF 切片",
        "TIF slice series working volume ready": "TIF 切片序列 working volume 已就绪",
        ...
        "Replace current labels?": "替换当前标注？",
        "Copy the latest model draft over the current labels? Unsaved changes will be discarded if the copy succeeds.": "是否用最新模型草稿替换当前标注？只有复制成功后，未保存的修改才会被丢弃。",
        "Unsaved current labels could not be restored after the model draft copy failed.": "模型草稿复制失败后，未能恢复尚未保存的当前标注。",
        "Current labels are marked unsaved, but the changed slices are unknown. Save or discard them before copying a model draft.": "当前标注被标记为尚未保存，但无法确定改动过的切片。请先保存或明确丢弃这些改动，再复制模型草稿。",
