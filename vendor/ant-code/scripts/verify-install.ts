...
import { ROOT, rel } from "./audit-common.ts";
...
async function checkPackageJson() {
  ...
  const expectedBins: Record<string, string> = {
    "ant-code": "./src/cli/index.ts",
    "lab-agent": "./src/cli/index.ts"
  };
 ...
 */
async function requireDocMarkers(relativePath: string, markers: readonly string[]) {
