...
class MultimodalValidator:
    ...
    def __init__(self, api_config: Dict[str, Any] | None = None):
        ...
        self.base_url = self._normalize_base_url(provider_config.get("base_url", "https://api.example.com/v1"))
        self.api_key = str(provider_config.get("api_key", "") or "").strip()
        self.model = str(provider_config.get("model", "Qwen/Qwen3-VL-32B-Instruct") or "Qwen/Qwen3-VL-32B-Instruct").strip()
