...
class LocatorScopeTests(unittest.TestCase):
    ...
    def test_project_cascade_routes_round_trip_with_portable_expert_reference(self):
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertEqual(route.get("expert_filename"), "best_expert.pth")
    ...
    def test_legacy_flat_route_migrates_to_project_v2_on_load_and_save(self):
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertEqual(saved_route["appointed_expert"]["expert_id"], "Mandible/best_expert.pth")
            self.assertEqual(saved_route["expert_candidates"][0]["expert_id"], "Mandible/best_expert.pth")

    def test_appointing_new_expert_preserves_previous_expert_as_history_candidate(self):
        pm = ProjectManager()
        pm.add_taxonomy_part("Mandible")
        pm.register_cascade_route_candidate("Head", "Mandible", save=False)
        pm.appoint_cascade_route_expert("Head", "Mandible", expert_id="Mandible/best_expert.pth", save=False)
        ...
        self.assertEqual(
            ...
            ["Mandible/mandible_v2.pth", "Mandible/best_expert.pth"],
        )
    ...
    def test_route_accessors_do_not_leak_mutable_nested_state(self):
        ...
        self.assertEqual(stored_route.get("appointed_expert", {}).get("expert_id"), "Mandible/best_expert.pth")
        self.assertEqual(
    ...
    def test_current_project_expert_bucket_impacts_only_report_matching_current_project_routes(self):
        ...
        pm.appoint_cascade_route_expert("Head", "Eye", expert_id="Eye/best_expert.pth", save=False)
