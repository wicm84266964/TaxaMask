...
import { verifyDashboardAssets } from "./dashboard-assets.ts";
...
async function copyResource(relativePath: string) {
...
function ignoreInkDevtoolsPlugin(): Plugin {
  return {
...
async function writeLauncher(name: string, target: string) {
