...
type ProvenanceRecord = {
  ...
  implementer_old_source_exposure?: string;
};
...
records.sort((a, b) => (a.module ?? "").localeCompare(b.module ?? ""));
 ...
 * @param {string} text
 */
function parseFrontMatter(text: string): Omit<ProvenanceRecord, "file"> {
