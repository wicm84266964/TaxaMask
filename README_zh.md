...
生物身体部位分割、organism body part segmentation、mask annotation、实例分割、分类学图像标注、形态学 mask 标注、Segment Anything、SAM 辅助标注、视觉语言模型、VLM 预标注、deep learning、computer vision、多模态数据集、COCO 数据集、JSONL 数据集、YOLO 格式、fine-tuning、可追溯工作流、数据集来源记录、AI 辅助标注、人工复核、形态学分割、分类学文献、新种描述、分类检索表、图版提取、caption 提取、训练数据集构建、智能体辅助工作流、源码辅助改造、可定制标注流程、生物多样性信息学、phenomics、生物影像、标本数字化、昆虫形态学、蚂蚁分类学、蚁科。
